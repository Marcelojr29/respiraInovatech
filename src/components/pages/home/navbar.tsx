        ...
        >
            <div className="container px-4 mx-auto flex justify-between items-center">
                ...
                <div className="hidden lg:flex space-x-12 text-2xl font-semibold text-white">
                    <a href="#Home" className="text-white hover:text-gray-400 transition-colors">
                        Home
                    </a>
                    <a href="#About" className="text-white hover:text-gray-400 transition-colors">
                        About
                    </a>
                    <a href="#Features" className="text-white hover:text-gray-400 transition-colors">
                        Features
                    </a>
                </div>
                ...
                <DropdownMenu open={isMenuOpen} onOpenChange={toggleMenu}>
                    ...
                    <DropdownMenuContent align="end" className="bg-custom-gradient text-white p-5 space-y-3">
                        <DropdownMenuItem onSelect={() => setIsMenuOpen(false)}>
                            <a href="#Home" className="block text-white hover:text-gray-400 transition-colors">
                                Home
                            </a>
                        </DropdownMenuItem>
                        <DropdownMenuItem onSelect={() => setIsMenuOpen(false)}>
                            <a href="#About" className="block text-white hover:text-gray-400 transition-colors">
                                About
                            </a>
                        </DropdownMenuItem>
                        <DropdownMenuItem onSelect={() => setIsMenuOpen(false)}>
                            <a href="#Contact" className="block text-white hover:text-gray-400 transition-colors">
                                Contact
                            </a>
                        </DropdownMenuItem>
                    </DropdownMenuContent>
